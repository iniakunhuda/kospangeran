    ...
    <div class="content-body">
        <div class="container-fluid">
            ...
            <div class="alert alert-dark">
                ...
                Pindah kamar tidak menghapus tagihan kamar lama
            </div>
            ...
            <div class="row justify-content-center">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4>Pindah ke kamar baru</h4>
                        </div>
                        <div class="card-body">
                            @include('layouts.components.alert')

                            <form action="{{ route('sewa.pindah.create', $sewa->id) }}" method="POST">
                                @csrf
                                <div class="form-group row">
                                    <input type="hidden" name="kamar_id_lama" value="{{ $sewa->kamar->id }}">
