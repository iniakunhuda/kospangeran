                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('tipe_kamar.store') }}" method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <select name="area_id" class="form-control single-select">
                                            ...
                                            <option value="{{ $area->id }}" {{ session('AREA_ID') == $area->id ? 'selected' : '' }}>{{ $area->judul }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" min="0" name="harga" class="form-control" placeholder="" value="0">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">Fasilitas</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="fasilitas[]" class="form-control" placeholder="">
                                    </div>
                                </div>
                                <div class="form-group row">
